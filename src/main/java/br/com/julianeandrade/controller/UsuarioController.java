package br.com.julianeandrade.controller;

import br.com.julianeandrade.entity.Usuario;
import br.com.julianeandrade.service.UsuarioService;
...
public class UsuarioController {
    ...
    @GET
    public Response listarUsuario(@QueryParam("pageSize") @DefaultValue("10") Integer pageSize,
                                  @QueryParam("page") @DefaultValue("0") Integer page){
        return Response.ok(service.listarUsuario(page, pageSize)).build();
    }
    @GET
    @Path("/{usuarioId}")
